export const DEPARTAMENTOS_MUNICIPIOS: Record<string, string[]> = {
  ...
  "Boyacá": [
    ...
    "Covarachía", "Cubará", "Cucaita", "Cuítiva", "Chiscas", "Duitama",
    ...
    "Tipacoque", "Toca", "Togüí", "Tópaga", "Tota", "Turmequé", "Tuta",
  ...
  "Chocó": [
    ...
    "Cértegui", "Condoto", "El Carmen de Atrato", "Istmina", "Juradó",
    "Litoral del San Juan", "Lloró", "Medio Atrato", "Medio Baudó",
    "Medio San Juan", "Nóvita", "Nuquí", "Río Iro", "Río Quito",
  ...
  "Cundinamarca": [
    ...
    "Caparrapí", "Cáqueza", "Carmen de Carupa", "Chaguaní", "Chipaque",
    ...
    "Ubalá", "Ubaque", "Villa de San Diego de Ubaté", "Une", "Útica",
  ...
  "Meta": [
    ...
    "Lejanías", "Mapiripán", "Mesetas", "La Uribe", "Puerto Concordia",
  ...
  "Nariño": [
    ...
    "Belén", "Buesaco", "El Charco", "El Peñol", "El Rosario",
  ...
  "Santander": [
    ...
    "Jordán", "La Belleza", "Landázuri", "La Paz", "Lebríja", "Los Santos",
  ...
  "Tolima": [
    ...
    "Lérida", "Líbano", "San Sebastián de Mariquita", "Melgar", "Murillo",
...
export const DEPARTAMENTO_COORDS: Record<string, [number, number]> = {
  "Amazonas":               [-1.2,  -71.9],
  "Antioquia":              [ 6.7,  -75.5],
  "Arauca":                 [ 6.6,  -70.7],
  "Atlántico":              [10.7,  -75.0],
  ...
  "Chocó":                  [ 5.7,  -76.6],
  "Córdoba":                [ 8.7,  -75.8],
  "Cundinamarca":           [ 4.9,  -74.0],
  "Guainía":                [ 2.6,  -68.5],
  "Guaviare":               [ 2.1,  -72.6],
  "Huila":                  [ 2.5,  -75.5],
  "La Guajira":             [11.5,  -72.9],
  "Magdalena":              [10.4,  -74.4],
  "Meta":                   [ 3.5,  -73.0],
  "Nariño":                 [ 1.3,  -77.3],
  ...
  "Quindío":                [ 4.5,  -75.7],
  "Risaralda":              [ 5.3,  -76.0],
  "San Andrés y Providencia":[12.5, -81.7],
  "Santander":              [ 6.6,  -73.1],
  "Sucre":                  [ 9.0,  -75.4],
  "Tolima":                 [ 4.1,  -75.2],
